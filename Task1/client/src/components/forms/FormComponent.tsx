...
const FormComponent = () => {
    ...
    const createNewRoomId = () => {
        ...
        toast.success("Created a new workspace Id")
    ...
    const validateForm = () => {
        if (currentUser.username.length === 0) {
            ...
            toast.error("Enter a workspace id")
            return false
        } else if (currentUser.roomId.length < 5) {
            toast.error("Workspace Id must be at least 5 characters long")
            return false
    ...
    const joinRoom = (e: FormEvent<HTMLFormElement>) => {
        ...
        toast.loading("Joining workspace...")
